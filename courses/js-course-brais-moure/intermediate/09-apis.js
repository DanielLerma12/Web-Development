...
// - GET: Obtener datos
// - POST: Enviar datos
// - PUT: Enviar datos y atualizar un recurso
// - DELETE: Solicitar para eliminar un recurso

// Códigos de respuesta HTTP:
// - 200: OK
// - 201: Ok + data
// - 400: Error de parte del cliente
// - 404: No encontrado
...
fetch("https://jsonplaceholder.typicode.com/mouredev")
  .then((response) => {
    if (!response.ok) {
      throw Error(`Status HTTP: ${response.status}`); // response.status: Código de error
    }
    return response.json();
  })
  .catch((error) => {
